...
namespace RestWithASPNETUdemy
{
    ...
    {      
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //SQL SERVER
            var connection = Configuration["ConnectionStrings:SQLServerConnectionStrings"];
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", 
                    new OpenApiInfo { 
                        Title = "REST API REST do 0 à Azure com ASP.NET Core 5 e Docker.", 
                        Version = "v1",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Importar os endpoits no Postman (https://localhost:44300/swagger/v1/swagger.json)
            app.UseSwagger();
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", 
                                  "REST API's RESTFul do 0 à Azure com ASP.NET Core 5 e Docker - v1");
            });
